        ...
        <div className="flex flex-row max-lg:flex-wrap items-center w-full gap-2.5 overflow-hidden p-2.5 max-md:max-w-full">
          <div className="flex flex-row justify-center items-center gap-2.5 w-full">
            <img
              ...
              className="object-contain w-[15%] min-w-[100px] max-w-[210px] shrink-0"
            />
            <img
              ...
              alt="Leaderboard decoration"
              className="object-contain w-[20%] min-w-[150px] max-w-[269px] shrink-0"
            />
            <img
              ...
              alt="Leaderboard decoration"
              className="object-contain w-[25%] min-w-[200px] max-w-[336px] shrink-0"
            />
          </div>
          <div className="flex flex-col items-center justify-center w-full p-2.5 max-md:max-w-full">
            ...
            />
            <div className="flex flex-col items-center w-full max-w-[608px] gap-2.5 overflow-hidden flex-wrap py-[15px] max-md:max-w-full max-md:px-5">
              <div className="flex w-full justify-center gap-2.5">
                <DownloadButton
                  store="apple"
                  icon=""
                  className="aspect-[2.6] w-[45%] min-w-[120px] max-w-[260px] max-md:w-[40%]"
                />
                <DownloadButton
                  store="play"
